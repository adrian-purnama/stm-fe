          ...
          if (response.data.success) {
            ...
            const quotationData = {
              header: {
                ...
                deliveryNotes: rfqData.deliveryNotes || '',
                targetCloseDate: rfqData.targetCloseDate || '',
                paymentTerms: rfqData.paymentTerms || '',
                inclusionNotes: rfqData.inclusionNotes || '',
                exclusionNotes: rfqData.exclusionNotes || '',
                isTaxIncluded: typeof rfqData.isTaxIncluded === 'boolean' ? rfqData.isTaxIncluded : false,
                includePPN: typeof rfqData.includePPN === 'boolean' ? rfqData.includePPN : true,
                bodyTypeId: rfqData.bodyTypeId || null,
                chassisTypeId: rfqData.chassisTypeId || null,
                deliveryLocation: rfqData.deliveryLocation || '',
                competitor: rfqData.competitor || '',
                confidenceRate: rfqData.confidenceRate ?? null,
                expectedDeliveryDate: rfqData.expectedDeliveryDate || '',
                approverId: rfqData.approverId || null,
                quotationCreatorId: rfqData.quotationCreatorId || null,
