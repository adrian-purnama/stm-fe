...
const ChassisTypesPage = () => {
  ...
  // State for selected chassis type
        ...
        {loading ? (
          ...
          <div className="divide-y divide-gray-200">
            {chassisTypes.map((chassisType) => (
              <div key={chassisType._id} className="p-6 hover:bg-gray-50 transition-colors">
...
export default ChassisTypesPage;
